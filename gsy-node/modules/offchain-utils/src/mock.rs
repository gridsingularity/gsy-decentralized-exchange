...
parameter_types! {
	...
	pub const MaxJobsPerBlockConst: u32 = 8;
}
...
// Provide the required bound for submitting unsigned from the OCW
impl frame_system::offchain::SendTransactionTypes<offchain_utils::pallet::Call<Test>> for Test {
