use crate::helpers::{init_app, TestApp};
use actix_web::web;
...
# [tokio::test]
async fn test_post_pv_asset_measurements() {
...
async fn test_post_battery_asset_measurements() {
    ...
    let battery_measurement = BatteryMeasurementSchema {
        ...
        current_A: 20.0,
        power_W: 2000.0,
        power_charge_W: 1500.0,
        power_discharge_W: 500.0,
        soc: 75.5,
        temperature_C: 25.0,
        voltage_V: 48.0,
    };
...
async fn test_post_smart_meter_asset_measurements() {
    ...
    let smart_meter_measurement = SmartMeterMeasurementSchema {
        ...
        energy_grid_injection_Wh: 1000.0,
        energy_grid_injection_day_Wh: 10000.0,
        grid_frequency: 50.0,
        current_A_p1: 5.0,
        current_A_p2: 5.1,
        current_A_p3: 5.2,
        ...
        power_W_p3: 1200.0,
        power_W_pv: 3000.0,
        reactive_power_var_p1: 100.0,
        reactive_power_var_p2: 110.0,
            reactive_power_var_p3: 120.0,
            voltage_V_p1: 230.0,
            voltage_V_p2: 231.0,
            voltage_V_p3: 232.0,
    };
