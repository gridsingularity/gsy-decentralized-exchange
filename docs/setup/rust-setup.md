...
Sometimes you can't get the GSy node
...
Substrate uses <a href="https://webassembly.org" target="_blank">WebAssembly</a> (Wasm) to produce portable blockchain
runtimes. You will need to configure your Rust compiler to use `nightly`
<a href="https://doc.rust-lang.org/book/appendix-07-nightly-rust.html" target="_blank">builds</a> to allow you to
...
> <a href="https://github.com/paritytech/substrate/issues/1252" target="_blank">This is the Parity tracking issue</a> if you're curious as to why and how this will be resolved.
...
developers. For instance, the Polkadot client specifies this information in its <a href="https://github.com/paritytech/polkadot/releases" target="_blank">release notes</a>.
