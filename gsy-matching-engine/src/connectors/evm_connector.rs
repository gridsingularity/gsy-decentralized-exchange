...
pub async fn evm_subscribe(
    ...
    pay_as_clear_pricing: PayAsClearPricing,
) -> Result<(), Error> {
...
async fn run_matching_cycle(
    ...
    let bid_offer_matches = match_order_books(order_books, matching_algorithm, pay_as_clear_pricing)?;
...
fn match_order_books(
    ...
    for mut matching_data in order_books {
        ...
        let matches = matching_algorithm
            .match_orders_with_pricing(&mut matching_data, pay_as_clear_pricing)
