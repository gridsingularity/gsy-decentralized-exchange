...
async fn submit_topology_forecasts_three_users(
	...
	let areas = vec![
		ExternalAreaTopology { area_uuid: format!("area{}", user1), area_name: user1.clone() },
		ExternalAreaTopology { area_uuid: format!("area{}", user2), area_name: user2.clone() },
		ExternalAreaTopology { area_uuid: format!("area{}", user3), area_name: user3.clone() },
	];
